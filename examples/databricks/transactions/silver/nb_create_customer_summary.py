...
# MAGIC
# MAGIC This notebook creates the customer_summary table. It joins the clean_transactions table with the raw_customers and aggregates them on the custome level creating a summary table which every row is a different customer.
